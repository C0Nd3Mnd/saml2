# ⚠️ DON'T use the package from this repository anymore!

You should probably use [darioackermann/saml2-js](https://github.com/darioackermann/saml2-js) instead as this version is actively maintained.
